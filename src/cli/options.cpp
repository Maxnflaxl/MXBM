...
std::string usage_text() {
    return
        ...
        "                         The CUDA solver picks its geometry ONCE at startup from\n"
        "                         the limit then on the card (applied by --pl or set\n"
        "                         beforehand, e.g. nvidia-smi -pl); changing the limit\n"
        "                         mid-run keeps the startup choice until a restart\n"
