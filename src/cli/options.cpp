...
std::string usage_text() {
    return
        ...
        "                         --pl value (needs root, ~15 min, no pool): a coarse pass\n"
        "                         across the card's band, then ~10 W steps around the knee.\n"
        "                         The result is stored per card; apply it with --pl auto.\n"
