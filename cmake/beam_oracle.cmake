...
# Optional Beam reference island for the differential test.
set(BEAM_SOURCE_DIR "$ENV{HOME}/Developer/Github/Beam/beam" CACHE PATH "Beam source root")
set(_bh3 "${BEAM_SOURCE_DIR}/3rdparty/crypto/beamHashIII_impl.cpp")
if(EXISTS "${_bh3}")
  add_library(beam_oracle STATIC "${_bh3}")
  # Compile ONLY beamHashIII_impl.cpp; blake symbols come from mxbm_blake2b.
  target_include_directories(beam_oracle PUBLIC "${BEAM_SOURCE_DIR}/3rdparty/crypto")
  ...
  message(STATUS "Beam differential oracle: ENABLED (${BEAM_SOURCE_DIR})")
else()
