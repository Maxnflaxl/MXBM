...
|---|---|---|
| Throughput | **69.90 sol/s** | 63.2 sol/s |
| End-to-end solve | **28.80 ms** | 31.8 ms |
| Board power | 273.1 W at the pin, near the card's 285 W limit; `sw_power_cap` intermittently active | — |
