...
statement that lane pairing is built to evade. By this table the gross is
≈ −2.2 ms at 140 W for round 3 alone, against a shuffle tax of roughly 16 extra
instructions per element at the cap's ×2–4.7 instruction pricing — a measurement,
gated on the goldens, `drops == 0` and unchanged occupancy.
