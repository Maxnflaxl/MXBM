...
|---|---|---|
| ms/solve median | **28.60** (spread 0.0 %) | a build change is real past ±0.5 % |
| sol/s | **70.30** | derived; quoted because the pin cites it |
| SM / mem clock | 2610 / 10251 MHz | must match, or it is a different V/f point |
| board draw | **268.1 W** | context, not a gate — 265–281 W across eight sessions at identical clocks and work |
