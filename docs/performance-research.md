...
deliberately does not price is the classification that fills the chunks; that
is the round-pair probe's job: r3's emit chunk-staged + r4's match consuming
via an L2-tile fine split, against the shipping pair, multiset-fingerprint
gated, at stock and 140 W.
