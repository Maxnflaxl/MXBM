...
Read this before proposing an optimization. The headline figures, the power curves, the
architecture and the open leads are on [performance.md](performance.md); this page is
what those conclusions rest on.
...
[the compute-hiding budget](performance.md#established-limits).
...
[128-bit accesses](performance.md#the-cuda-backend) are legal. That pad is not free. Round 2 writes it
...
[lead 5](performance.md#current-focus-and-open-leads).)*
...
anyway** — see [4a](performance.md#current-focus-and-open-leads): ~636 is the Poisson maximum over
...
> [traffic table](performance.md#current-focus-and-open-leads) — it scaled round 2's
...
*(What the backend is and where it stands today is on
[performance.md](performance.md#the-cuda-backend). This is what the profiler found and
