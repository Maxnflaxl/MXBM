...
worse again at 140 W. The mechanism is granularity, not bandwidth: an
...
be built at this geometry. *Comes back only with a split that beats 9.0 ms per
2.13 GB layer into fine-row form, or a match structure that consumes coarse
buckets directly.*
